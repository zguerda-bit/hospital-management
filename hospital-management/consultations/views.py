...
class CreateAppointmentView(APIView):
    ...
    def post(self, request):
        """
        Body: { "doctor_id": 1, "patient_id": 2,
                "date_rdv": "2025-09-01T10:00:00", "reason": "..." }
        """
...
class CompleteConsultationView(APIView):
    ...
    def post(self, request, appointment_id):
        ...
        Body:
        {
          ...
          "traitement":   { "medicament": "Ventoline", "dose": "2 puffs",
                            "duree": "7 jours", "instructions": "..." }
        }
        """
        appointment = get_object_or_404(Appointment, id=appointment_id)
        ...
        for a in appointments:
            ...
            if consultation:
                entry['consultation'] = {
                    ...
                    'observation':       consultation.observation,   # fixed field name
                    'diagnostics': [
                        {
