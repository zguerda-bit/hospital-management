    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Administrateur'), ('DOCTOR', 'Médecin'), ('PATIENT', 'Patient')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phn', models.CharField(max_length=20, unique=True)),
                ('nom_parent', models.CharField(default='Parent', max_length=100)),
